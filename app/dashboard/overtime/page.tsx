  ...
  return (
    <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs" style={{ color: '#6b7f78' }}>
                Backend hiện xác định loại OT theo ngày làm việc thực tế. Dự đoán từ ngày đã chọn:{' '}
                <strong>{getOtTypeLabel(backendDetectedType)}</strong>.
              </p>
            </div>
      ...
      <div className="rounded-xl border bg-white p-5" style={{ borderColor: '#e2ede9' }}>
        ...
        >
          <strong>Quy tắc tính Comp-off:</strong> Ngày thường: 1h OT = 1h nghỉ bù | Cuối tuần: 1h OT
          = 1.5h nghỉ bù | Ngày lễ: 1h OT = 2h nghỉ bù
        </div>
                ...
                compOffRows.map((row) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-xs font-bold" style={{ color: '#1DB87A' }}>
