      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-6xl flex min-h-[600px]">
        ...
        >
          <div>
            ...
            >
              Hệ thống quản lý nghỉ phép hiện đại, dễ sử dụng và hiệu quả cho doanh nghiệp
            </p>
          </div>
          ...
          <div className="text-white/60 text-sm">© 2026 Leave Management System</div>
        </div>
          ...
          <div className="max-w-md mx-auto w-full">
            <div className="mb-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-3xl font-bold" style={{ color: '#0E474E' }}>
                  Đăng nhập
                </h2>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-semibold mb-2" style={{ color: '#203430' }}>
                  Tên đăng nhập
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    onFocus={(e) => (e.currentTarget.style.borderColor = '#1DB87A')}
            ...
            {/* <div className="mt-8">
              <div
                ...
                style={{ color: '#6b7f78' }}
              >
                <div className="h-px flex-1" style={{ background: '#e2ede9' }} />
              ...
              <div className="grid grid-cols-2 gap-2">
                {DEMO_ACCOUNTS.map((account, i) => (
                  <button
                    ...
                    style={{
                      borderColor: copiedIndex === i ? '#1DB87A' : '#e2ede9',
                      background: copiedIndex === i ? '#f0f9f5' : '#fff',
                    }}
                  >
                    <div className="flex items-center gap-1.5 mb-1">
                      {copiedIndex === i && <CheckCircle2 size={14} style={{ color: '#1DB87A' }} />}
                      <span className="font-bold text-xs" style={{ color: '#0E474E' }}>
                        {account.label}
                      </span>
                    </div>
